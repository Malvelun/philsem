...
public class HelloWorldSpeechlet implements SpeechletV2 {
    ...
    public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
        ...
        if ("VeranstaltungenIntent".equals(intentName)) {
    ...
    private SpeechletResponse getHelloResponse() {
    		String speechText = "Ich konnte leider keine Veranstaltungen finden";
    		GetNews gn = new GetNews();
    		Map<String,String> events = gn.getVeranstaltungenHeader();
    		if (events.keySet().size() > 0) {
    			speechText = "Ich habe folgende Veranstaltungen gefunden: ";
        		int counter = 0;
        		for (String event : events.keySet()) {
        			speechText += counter+". : "+event;
        		
        		}
        		speechText += ". Für welche Veranstalung möchtest du Informationen?";
    		}
